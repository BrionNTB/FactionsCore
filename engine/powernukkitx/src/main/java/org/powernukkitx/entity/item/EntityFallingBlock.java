...
import org.powernukkitx.event.entity.EntityBlockChangeEvent;
...
public class EntityFallingBlock extends Entity {
    ...
    protected boolean requiresPreciseMovementSync() {
        // Sand/gravel/anvil cannons time their pushes off the falling block's visible
        // position, same as primed TNT.
        return true;
    }
}
